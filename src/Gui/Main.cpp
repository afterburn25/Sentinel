...
private:
    ...
    void DrawSidebar() {
        ...
        Text(L"Sentinel v1.0.2",24,674,170,20,smallFmt_.Get(),brush_.muted.Get());
    ...
    void DrawSettings(float w,float h) {
        ...
        TextLine(L"Sentinel 1.0.2",rx+104,y+60,rightW-124,30,bodyFmt_.Get(),brush_.text.Get());
