...
SimulationSettings LoadSimulationSettings(const std::filesystem::path& path) {
    ...
    while(std::getline(in,line)) {
        ...
        try {
            ...
            else if(k=="persona.gender") s.persona.gender=v;
            else if(k=="persona.pronouns") s.persona.pronouns=v;
            else if(k=="persona.occupation") s.persona.occupation=v;
            else if(k=="persona.education") s.persona.education=v;
            else if(k=="persona.relationshipStatus") s.persona.relationshipStatus=v;
            else if(k=="persona.familyContext") s.persona.familyContext=v;
            else if(k=="persona.personality") s.persona.personality=v;
            else if(k=="persona.socialStyle") s.persona.socialStyle=v;
            else if(k=="persona.confidenceLevel") s.persona.confidenceLevel=v;
...
void SaveSimulationSettings(const std::filesystem::path& path,const SimulationSettings& s) {
    ...
    out<<"persona.gender="<<Escape(s.persona.gender)<<"\n";
    out<<"persona.pronouns="<<Escape(s.persona.pronouns)<<"\n";
    out<<"persona.occupation="<<Escape(s.persona.occupation)<<"\n";
    out<<"persona.education="<<Escape(s.persona.education)<<"\n";
    out<<"persona.relationshipStatus="<<Escape(s.persona.relationshipStatus)<<"\n";
    out<<"persona.familyContext="<<Escape(s.persona.familyContext)<<"\n";
    out<<"persona.personality="<<Escape(s.persona.personality)<<"\n";
    out<<"persona.socialStyle="<<Escape(s.persona.socialStyle)<<"\n";
    out<<"persona.confidenceLevel="<<Escape(s.persona.confidenceLevel)<<"\n";
